...
#if !defined(ALIZE_MixtureServerFileReader_cpp)
#define ALIZE_MixtureServerFileReader_cpp
...
//-------------------------------------------------------------------------
R::MixtureServerFileReader(const FileName& f, const Config& c)
:MixtureServerFileReaderAbstract(NULL), _pServerReader(&createReader(f, c))
{}
//-------------------------------------------------------------------------
...
{
  if (_pServerReader != NULL)
    delete _pServerReader;
}
//-------------------------------------------------------------------------

#endif // !defined(ALIZE_MixtureServerFileReader_cpp)
