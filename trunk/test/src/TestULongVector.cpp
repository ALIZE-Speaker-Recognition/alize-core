...
#if !defined(ALIZE_TestULongVector_cpp)
#define ALIZE_TestULongVector_cpp
...
//-------------------------------------------------------------------------
TestULongVector::TestULongVector()
:Test() {}
//-------------------------------------------------------------------------
bool TestULongVector::exec()
{
    Test::exec();
    {
        typedef ULongVector V;

        // test method : String getClassName() const

        test(V().getClassName() == "ULongVector", __LINE__);
        ...
        {
            V v;
            v.addValue(11).addValue(22).addValue(33);
        ...
        {
            V v, v1;
            v.addValue(11).addValue(22).addValue(33).addValue(v1);
            test(v._size == 3, __LINE__);
            test(v._array[0] == 11, __LINE__);
            test(v._array[1] == 22, __LINE__);
            test(v._array[2] == 33, __LINE__);
        ...
        {
            V v1;
            v1.addValue(11).addValue(22).addValue(33);
            const V v(v1);
            test(v._size == 3, __LINE__);
        ...
        {
            V v;
            v.addValue(11).addValue(22).addValue(33).clear();
            test(v._size == 0, __LINE__);
            test(v._capacity == 4, __LINE__);
        }
        ...
        // test method : bool operator==(const ULongVector&) const
        //  and method : bool operator!=(const ULongVector&) const
        {
            V v;
            v.addValue(11).addValue(22).addValue(33);
            V v1(v);
        ...
        // test method : const ULongVector& ULongVector::operator=
        // 26 jan 2004                            (const ULongVector& v)
        {
            V v;
            v.addValue(11).addValue(22).addValue(33);
            V v1;
...
//-------------------------------------------------------------------------
String TestULongVector::getClassName() const { return "TestULongVector"; }
//-------------------------------------------------------------------------
TestULongVector::~TestULongVector() {}
//-------------------------------------------------------------------------

#endif // !defined(ALIZE_TestULongVector_cpp)
