...
#if !defined(ALIZE_TestRealVector_cpp)
#define ALIZE_TestRealVector_cpp
...
//-------------------------------------------------------------------------
TestRealVector::TestRealVector()
:Test() {}
//-------------------------------------------------------------------------
bool TestRealVector::exec()
{
  Test::exec();
  {
    typedef RealVector<double> V;

    // test method : String getClassName() const

    test(V().getClassName() == "RealVector", __LINE__);
    ...
    // test method : bool operator==(const RealVector&) const
    //  and method : bool operator!=(const RealVector&) const
    {
      V v;
      v.addValue(11);
      v.addValue(22);
    ...
    // test method : const RealVector& RealVector::operator=
    // 26 jan 2004              (const RealVector& v)
    {
      V v;
      v.addValue(11);
      v.addValue(22);
    ...
    // test method : void setValues(const RealVector&)
    {
      V v;
      v.addValue(1);
      v.addValue(2);
...
//-------------------------------------------------------------------------
String TestRealVector::getClassName() const
{
  return "TestRealVector";
}
//-------------------------------------------------------------------------
TestRealVector::~TestRealVector() {}
//-------------------------------------------------------------------------

#endif // !defined(ALIZE_TestRealVector_cpp)
