...
#if !defined(ALIZE_ConfigFileReaderXml_h)
#define ALIZE_ConfigFileReaderXml_h
...
namespace alize
{
  ...
  class ALIZE_API ConfigFileReaderXml : public ConfigFileReaderAbstract, private XmlParser
  {
    friend class TestConfigFileReader;
  ...
  public :
    ...
    ///
    explicit ConfigFileReaderXml(const FileName& f);
  ...
  private :
    ...
    bool operator!=(const ConfigFileReaderXml&)
                          const; /*!Not implemented*/
    const ConfigFileReaderXml& operator=(
               const ConfigFileReaderXml&); /*!Not implemented*/
    ConfigFileReaderXml(
               const ConfigFileReaderXml&); /*!Not implemented*/
  };
...
#endif // !defined(ALIZE_ConfigFileReaderXml_h)
