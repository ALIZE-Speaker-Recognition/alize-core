...
#if !defined(ALIZE_MixtureGD_h)
#define ALIZE_MixtureGD_h
...
namespace alize
{
  ...
  /// Class for a mixture of gaussian distributions with diagonal vector
  /// of covariance (DistribGD objects).
  ///
  /// @author Frederic Wils  frederic.wils@lia.univ-avignon.fr
  /// @version 1.0
  /// @date 2003

  class ALIZE_API MixtureGD : public Mixture
  {
  ...
  public :
    ...
    MixtureGD& duplicate(const K&, DuplDistrib) const; // not virtual
    ...
    /// @param d DistribGD object to add
    ...
    /// @param w weight of the distribution
    /// @exception Exception if d is not a DistribGD object
    ...
    /// @param d DistribGD object to set
    ...
    /// @exception IndexOutOfBoundsException
    ///    
    DistribGD& getDistrib(unsigned long index) const; // NOT virtual method
  ...
  private :
    ...
    virtual MixtureStat& createNewMixtureStatObject(
                     const K&, StatServer&, const Config&) const;
  };

} // end namespace alize

#endif // !defined(ALIZE_MixtureGD_h)
