...
#if !defined(ALIZE_TestMixtureFileReaderAmiral_cpp)
#define ALIZE_TestMixtureFileReaderAmiral_cpp
...
//-------------------------------------------------------------------------
TestMixtureFileReaderAmiral::TestMixtureFileReaderAmiral()
:Test() {}
//-------------------------------------------------------------------------
bool TestMixtureFileReaderAmiral::exec()
{
    Test::exec();
    {
...
//-------------------------------------------------------------------------
String TestMixtureFileReaderAmiral::getClassName() const
{ return "TestMixtureFileReaderAmiral"; }
//-------------------------------------------------------------------------
TestMixtureFileReaderAmiral::~TestMixtureFileReaderAmiral() {}
//-------------------------------------------------------------------------

#endif // !defined(ALIZE_TestMixtureFileReaderAmiral_cpp)
