...
#if !defined(ALIZE_TestDoubleVector_cpp)
#define ALIZE_TestDoubleVector_cpp

#include "TestDoubleVector.h"
...
//-------------------------------------------------------------------------
TestDoubleVector::TestDoubleVector()
:Test() {}
//-------------------------------------------------------------------------
bool TestDoubleVector::exec()
{
  Test::exec();
  {
    typedef DoubleVector V;

    // test method : String getClassName() const

    test(V().getClassName() == "DoubleVector", __LINE__);
    ...
    // test method : bool operator==(const DoubleVector&) const
    //  and method : bool operator!=(const DoubleVector&) const
    {
      V v;
      v.addValue(11);
      v.addValue(22);
    ...
    // test method : const DoubleVector& DoubleVector::operator=
    // 26 jan 2004              (const DoubleVector& v)
    {
      V v;
      v.addValue(11);
      v.addValue(22);
    ...
    //              const bool updateCapacity);
    {
      V v(100, 100);
      v.setSize(10);
      test(v.size() == 10, __LINE__);
      v.setSize(10, true);
      test(v.size() == 10 && v._capacity == 10, __LINE__);
      v.setSize(20);
      test(v.size() == 20, __LINE__);
      v.setSize(10, true);
      test(v.size() == 10 && v._capacity == 10, __LINE__);
    }
    // test method : void setValues(const DoubleVector&)
    {
      V v;
      v.addValue(1);
      v.addValue(2);
    ...
    // test operator +=(DoubleVector)
    {
      ...
      {
        v1 += v2;
        test(v1[0] == 15, __LINE__);
        test(v1[1] == 18, __LINE__);
      }
      catch (Exception&) { showError(__LINE__); }
      v2.addValue(1);
      try
      {
        v1 += v2; // must throw an exception
        showError(__LINE__);
      }
      catch (Exception&) {}
    }
    // test operator *=(double)
    {
      ...
      v1.addValue(5);
      V v2(v1 *= 2);
      test(v1[0] == 6, __LINE__);
      test(v1[1] == 10, __LINE__);
      test(v1 == v2, __LINE__);
    }
...
//-------------------------------------------------------------------------
String TestDoubleVector::getClassName() const
{
  return "TestDoubleVector";
}
//-------------------------------------------------------------------------
TestDoubleVector::~TestDoubleVector() {}
//-------------------------------------------------------------------------

#endif // !defined(ALIZE_TestDoubleVector_cpp)
