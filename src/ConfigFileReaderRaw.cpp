...
//-------------------------------------------------------------------------
ConfigFileReaderRaw::ConfigFileReaderRaw(const FileName& f)
:ConfigFileReaderAbstract(f) {}
//-------------------------------------------------------------------------
void ConfigFileReaderRaw::readConfig(Config& c)
{
  c.reset();
...
#endif // !defined(ALIZE_ConfigFileReaderRaw_cpp)
