...
#if !defined(ALIZE_SegServerFileReaderAbstract_cpp)
#define ALIZE_SegServerFileReaderAbstract_cpp
...
//-------------------------------------------------------------------------
R::SegServerFileReaderAbstract(const FileName& f, const Config& c)
...
#endif // !defined(ALIZE_SegServerFileReaderAbstract_cpp)
