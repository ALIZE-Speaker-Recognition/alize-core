...
#if !defined(ALIZE_MixtureGDStat_h)
#define ALIZE_MixtureGDStat_h
...
namespace alize
{
  ...
  /// Class used to make specific calculation in a MixtureGD object
  ...
  class ALIZE_API MixtureGDStat : public MixtureStat
  {
    friend class TestMixtureGDStat;
  
  public :

    explicit MixtureGDStat(const K&, StatServer&, const MixtureGD&, const Config&);
    static MixtureGDStat& create(const K&, StatServer&,
                                 const MixtureGD& m, const Config&);
  ...
  private :
    ...
    MixtureGDStat(const MixtureGDStat&); /*!Not implemented*/
    const MixtureGDStat& operator=(
                const MixtureGDStat&); /*!Not implemented*/
    bool operator==(const MixtureGDStat&) const; /*!Not implemented*/
    bool operator!=(const MixtureGDStat&) const; /*!Not implemented*/
  };

} // end namespace alize

#endif // !defined(ALIZE_MixtureGDStat_h)
