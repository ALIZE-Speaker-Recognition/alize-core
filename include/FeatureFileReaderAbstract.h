...
#if !defined(ALIZE_FeatureFileReaderAbstract_h)
#define ALIZE_FeatureFileReaderAbstract_h
...
namespace alize
{
  ...
  class ALIZE_API FeatureFileReaderAbstract : public FeatureInputStream
  {
  public :

    FeatureFileReaderAbstract(FileReader*, 
             const Config&, LabelServer*, BufferUsage,
             unsigned long bufferSize, HistoricUsage,
             unsigned long historicSize);
    virtual ~FeatureFileReaderAbstract();

    /// Connects an external buffer to the reader. This buffer will
...
#endif // !defined(ALIZE_FeatureFileReaderAbstract_h)
