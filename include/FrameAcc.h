...
#if !defined(ALIZE_FrameAcc_h)
#define ALIZE_FrameAcc_h
...
namespace alize
{
  ...
  /// Abstract class used to compute mean and covariance of a set of 
  /// features
  ///
  ...
  /// @date 2003
  ///
  class ALIZE_API FrameAcc : public Object
  {
  public :
    explicit FrameAcc();
    virtual ~FrameAcc();
    ...
    /// @return the parameters mean vector
    ///
    const DoubleVector& getMeanVect();

    /// Returns the accumulated parameters vector
    /// @return the accumulated parameters vector
    ///
...
#endif // !defined(ALIZE_FrameAcc_h)
