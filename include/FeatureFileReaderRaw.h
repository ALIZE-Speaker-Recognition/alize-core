...
#if !defined(ALIZE_FeatureFileReaderRaw_h)
#define ALIZE_FeatureFileReaderRaw_h
...
namespace alize
{
  ...
  class ALIZE_API FeatureFileReaderRaw : public FeatureFileReaderSingle
  {
  ...
  public :
    ...
    ///        BIGENDIAN_FALSE
    ///
    FeatureFileReaderRaw(const FileName& f,
    ...
    ///
    static FeatureFileReaderRaw& create(const FileName&, const Config&,
  ...
  private :
    ...
    bool operator==(const FeatureFileReaderRaw&)
                         const; /*!Not implemented*/
    bool operator!=(const FeatureFileReaderRaw&)
                         const; /*!Not implemented*/
    const FeatureFileReaderRaw& operator=(
             const FeatureFileReaderRaw&); /*!Not implemented*/
    FeatureFileReaderRaw(
             const FeatureFileReaderRaw&); /*!Not implemented*/
  };

} // end namespace alize

#endif // !defined(ALIZE_FeatureFileReaderRaw_h)
